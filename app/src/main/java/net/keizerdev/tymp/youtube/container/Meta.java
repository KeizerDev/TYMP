...
public class Meta {
    ...
    public Meta(int itag, String ext, VCodec vCodec, ACodec aCodec, int audioBitrate, boolean isDashContainer) {
        this.itag = itag;
        this.ext = ext;
        this.height = -1;
        this.fps = 30;
    ...
    public Meta(int itag, String ext, int height, VCodec vCodec, ACodec aCodec, int audioBitrate,
